# sfw/bash/url-sniper/funcs/create-relative-7z-package.spec.sh
...
doSpecCreateRelative7zPackage(){
	...
	cat docs/txt/url-sniper/specs/pckg/create-relative-7z-package.spec.txt
...
# eof file: sfw/bash/url-sniper/funcs/create-relative-7z-package.spec.sh
