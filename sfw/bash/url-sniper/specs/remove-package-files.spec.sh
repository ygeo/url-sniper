# sfw/bash/url-sniper/funcs/remove-package-files.spec.sh
...
doSpecRemovePackageFiles(){
	...
	cat docs/txt/url-sniper/specs/remove-package-files.spec.txt
...
# eof file: sfw/bash/url-sniper/funcs/remove-package-files.spec.sh
