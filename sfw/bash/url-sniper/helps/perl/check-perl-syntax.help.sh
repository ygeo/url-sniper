# sfw/bash/url-sniper/funcs/check-perl-syntax.help.sh
...
doHelpCheckPerlSyntax(){
	...
	cat docs/txt/url-sniper/helps/check-perl-syntax.help.txt
...
# eof file: sfw/bash/url-sniper/funcs/check-perl-syntax.help.sh
