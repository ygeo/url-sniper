#!/bin/bash 
# file: sfw/bash/url-sniper/test-url-sniper.sh
...
doRunTests(){
	...
	while read -r action ; do (
		...
		done < <(find sfw/bash/url-sniper/tests -type f -name '*.sh')

		doLog "INFO STOP  :: testing action: \"$action\""
	);
	done < <(cat $product_instance_dir/sfw/bash/url-sniper/tests/run-url-sniper-tests.lst)
...
#----------------------------------------------------------
# Purpose:
# a simplistic tester for the simplistic bash stub url-sniperer
#----------------------------------------------------------
#
#----------------------------------------------------------
...
#----------------------------------------------------------
#
# eof file: sfw/bash/url-sniper/test-url-sniper.sh
