package UrlSniper::App::Utils::Logger ;
...
Perhaps a little code snippet.
    ...
    use UrlSniper::Control::Utils::Logger ; 

    my $objLogger = UrlSniper::Control::Utils::Logger->new( \$appConfig ) ;
    ...
...
=cut
	...
	sub Initialize {
		...
		$objTimer               = 'UrlSniper::App::Utils::Timer'->new( $appConfig->{ 'TimeFormat' } );
