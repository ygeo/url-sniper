# src/bash/url-sniper/funcs/build-docker-image.spec.sh
...
doSpecBuildDockerImage(){
	...
	cat doc/txt/url-sniper/specs/build-docker-image.spec.txt
...
# eof file: src/bash/url-sniper/funcs/build-docker-image.spec.sh
