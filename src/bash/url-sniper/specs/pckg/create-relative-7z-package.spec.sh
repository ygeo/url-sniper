# src/bash/url-sniper/funcs/create-relative-7z-package.spec.sh
...
doSpecCreateRelative7zPackage(){
	...
	cat doc/txt/url-sniper/specs/pckg/create-relative-7z-package.spec.txt
...
# eof file: src/bash/url-sniper/funcs/create-relative-7z-package.spec.sh
