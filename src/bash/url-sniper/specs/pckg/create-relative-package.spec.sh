# src/bash/url-sniper/funcs/create-relative-package.spec.sh
...
doSpecCreateRelativePackage(){
	...
	cat doc/txt/url-sniper/specs/pckg/create-relative-package.spec.txt
...
# eof file: src/bash/url-sniper/funcs/create-relative-package.spec.sh
