# src/bash/url-sniper/funcs/check-perl-syntax.spec.sh
...
doSpecCheckPerlSyntax(){
	...
	cat doc/txt/url-sniper/specs/check-perl-syntax.spec.txt
...
# eof file: src/bash/url-sniper/funcs/check-perl-syntax.spec.sh
