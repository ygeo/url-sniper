# src/bash/url-sniper/funcs/run-perl-tests.func.sh
...
doRunPerlTests(){
   ...
   done < <(find "$product_instance_dir/src/perl/url_sniper/t" -type f -name '*.t')
...
# eof file: src/bash/url-sniper/funcs/run-perl-tests.func.sh
