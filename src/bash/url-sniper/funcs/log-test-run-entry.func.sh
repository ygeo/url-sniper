# src/bash/url-sniper/funcs/log-test-run-entry.func.sh
...
doLogTestRunEntry(){
   ...
   case "$1" in
     INIT)
         # cat doc/txt/url-sniper/funcs/log-test-run-entry.func.txt
...
# eof file: src/bash/url-sniper/funcs/log-test-run-entry.func.sh
