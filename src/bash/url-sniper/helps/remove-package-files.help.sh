# src/bash/url-sniper/funcs/remove-package-files.help.sh
...
doHelpRemovePackageFiles(){
	...
	cat doc/txt/url-sniper/helps/remove-package-files.help.txt
...
# eof file: src/bash/url-sniper/funcs/remove-package-files.help.sh
