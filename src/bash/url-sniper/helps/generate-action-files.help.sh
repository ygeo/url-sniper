# src/bash/url-sniper/funcs/generate-action-files.help.sh
...
doHelpGenerateActionFiles(){
	...
	cat doc/txt/url-sniper/helps/generate-action-files.help.txt
...
# eof file: src/bash/url-sniper/funcs/generate-action-files.help.sh
