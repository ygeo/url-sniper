...
doTestCreateRelativePackage(){
   ...
   bash src/bash/url-sniper/url-sniper.sh -a create-relative-package -i met/.tst.url-sniper
   export exit_code=$?
   ...
   test $exit_code -ne 0 && return
	...
	bash src/bash/url-sniper/url-sniper.sh -a create-relative-package -i met/.prd.url-sniper
   export exit_code=$?
   ...
   # test the call with the include file of the prd env
   bash src/bash/url-sniper/url-sniper.sh -a create-relative-package -i met/.git.url-sniper
   export exit_code=$?
