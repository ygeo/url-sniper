# src/bash/url-sniper/funcs/log-test-run-entry.test.sh
...
doTestLogTestRunEntry(){
	...
	cat doc/txt/url-sniper/tests/log-test-run-entry.test.txt
...
# eof file: src/bash/url-sniper/funcs/log-test-run-entry.test.sh
