# src/bash/url-sniper/funcs/remove-package-files.test.sh
...
doTestRemovePackageFiles(){
	...
	cat doc/txt/url-sniper/tests/remove-package-files.test.txt
...
# eof file: src/bash/url-sniper/funcs/remove-package-files.test.sh
